...
DERIVED_HEADER = (
    "# Derived from galago-tools interfaces/tools/grpc_interfaces/{proto}\n"
...
def generate() -> None:
    ...
    # Apache-2.0 section 4(b): say where each generated file came from and
    # that it was changed.
    for generated in sorted((GEN_DIR / "tools" / "grpc_interfaces").glob("*.py*")):
        proto = generated.name.split("_pb2")[0] + ".proto"
        text = generated.read_text()
        generated.write_text(DERIVED_HEADER.format(proto=proto) + text)
    ...
    (GEN_DIR / "__init__.py").write_text(
        ...
        "Derived from galago-tools (https://github.com/sciencecorp/galago-tools),\n"
        "Copyright 2025 - Science Corporation, Apache License 2.0; see NOTICE.\n"
        '"""\n\n'
